...
//        //                instrumentId = _instrumentRepository.InsertInstrument(position.Conid.ToString(), position.Symbol, position.ListingExchange, position.Currency, position.AssetCategory, "IBKR", "IBKR");
//        //            }
//        //            if (instrumentId != null)
//        //            {
...
//        //                instrumentId = _instrumentRepository.InsertInstrument(instrument.ConId, instrument.InstrumentName, instrument.ListingExchange, instrument.Currency, instrument.ContractUnitType, "IBKR", "IBKR");
//        //            }
//        //            if (instrumentId != null)
//        //            {
//        //                List<(DateTime startDate, DateTime endDate)> missingRanges = GetMissingRanges(
