...
namespace IKBR_Report_Puller.Data.Repositories
{
    public class PositionRepository : BaseRepository, IPositionRepository
    {
        ...
        /// <summary>
        /// Inserts new positions into the database
        /// </summary>
        void IPositionRepository.InsertPositions(List<Position> positions)
        {
            if (positions == null || !positions.Any())
            {
                Console.WriteLine("No positions to insert.");
                return;
            }
            ...
            ExecuteDatabaseOperation(connection =>
            {
                using (var transaction = connection.BeginTransaction())
                {
                    ...
                    {
                        // Ensure instrument exists before inserting position
                ...
                Console.WriteLine($"Successfully inserted {positions.Count} positions.");
            });
        }
    }
    /// <summary>
