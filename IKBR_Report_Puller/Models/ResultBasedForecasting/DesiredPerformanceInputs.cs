...
{
    public class DesiredPerformanceInputs
    {
        public DesiredPerformanceInputs(decimal portfolioSizeCurrency, decimal positionSizePercent, decimal desiredReturnPercent, decimal averageGainPercent, decimal averageLossPercent, decimal winningTradePercent)
        {
